...
exe "hi Repeat          guifg=".statement_color_bold              
exe "hi Label           guifg=".statement_color_italic            
hi Operator        guifg=#CC6699               gui=none           
exe "hi Keyword         guifg=".statement_color_bold              
exe "hi Exception       guifg=".statement_color_bold              
                                                                  "
